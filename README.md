...
镜像：`csania/kiro-rs:latest`（不含本次修复的请用上游镜像 `ghcr.io/hank9999/kiro-rs:latest`）。
...
```bash
docker pull csania/kiro-rs:latest
# 或指定版本
docker pull csania/kiro-rs:v1.1.31
```
